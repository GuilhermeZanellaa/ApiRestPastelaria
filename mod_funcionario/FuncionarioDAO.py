...
def post_funcionario(id: int, f: Funcionario):
    return {"msg": "post executado", "id": id, "nome": f.nome, "cpf": f.cpf, "telefone": f.telefone, "grupo": f.grupo, "senha": f.senha}, 200


@router.put("/funcionario/{id}", tags=["funcionario"])
def put_funcionario(id: int, f: Funcionario):
    return {"msg": "put executado", "id": id, "nome": f.nome, "cpf": f.cpf, "telefone": f.telefone, "grupo": f.grupo, "senha": f.senha}, 201
